...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "kamina") || (event.body.toLowerCase() == "sala")) {
       return api.sendMessage("Gali na de Hanzu ko bata dungi🙄🙄🙏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "Zahra") || (event.body.toLowerCase() == "ayehsa")) {
       return api.sendMessage("hye ZAHEA Mara Boss ke Wife ha bari kush naseeb ha 🙈❤️", threadID);
     };
       if ((event.body.toLowerCase() == "hanzu Kon ho ap") || (event.body.toLowerCase() == "shaan  kon hai")) {
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Hanzu ki setting hu", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞𒁍 𓆩๛⃝𝐎𝐖𝐍𝐄𝐑 𝐇𝐀𝐍𝐙𝐔‣᭄𓆪 𝚢𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝙃𝘼𝙉𝙕𝙐. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/profile.php?id=61572573580624𝙈𝙍.𝙃𝘼𝙉𝙕𝙐 345☞    his insta id 345 ☜ ༺༒ ༒", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𒁍 𓆩๛⃝𝐎𝐖𝐍𝐄𝐑 𝐇𝐀𝐍𝐙𝐔‣᭄𓆪 . He Gives his name mr Hanzu everywhare", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     ...
     if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
       return api.sendMessage("sorry malik maaf kr do ab nhi krugi Hanzu please maaf karo na🥺🙏", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot kiss me") || (event.body.toLowerCase() == "kiss me")) {
       return api.sendMessage("️Kis khushi me, Me sirf Apne Boss Hanzu ko kiss karna chahti hu", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE HANZU KO DEKHO PYARA NA LAGY PAISE WAPIS 😝😂 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍")) {return api.sendMessage("IS NAZAR SE MERE OWNER HANZU  KO DEKHO MAZA NA AY TO PAISE WAPIS 😝😂 ", threadID);
     };
